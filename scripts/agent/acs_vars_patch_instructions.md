# ACS Variables Master JSON Creation Instructions

Perform the following steps to the content of the markdown file:

The markdown file contains:

- First level headings indicating different categories (omitting the code before the colon).
- Second level headings indicating group categories within each first level heading (omitting the code before the colon and parentheses).
- Lines of variable definitions formatted as "VariableName (Alias);".
